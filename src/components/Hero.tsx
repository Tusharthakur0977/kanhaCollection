      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{animationDelay: '1s'}}>
            <Link
              to="/products"
              className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white px-8 py-4 rounded-full hover:from-orange-600 hover:to-yellow-600 transition-all duration-300 flex items-center space-x-2 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 hover:-translate-y-1 animate-pulse"
            >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 animate-slide-up" style={{animationDelay: '1.5s'}}>
            ...
            <div className="text-center transform hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-600">Simple checkout process via WhatsApp</p>
            </div>
          </div>
        </div>
      </div>
